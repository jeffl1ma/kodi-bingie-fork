...
radios = {
    'master': 'https://hls.hunter.fm/master/192.m3u8',
    'sertanejo': 'https://hls.hunter.fm/sertanejo/192.m3u8', 
    ...
    'kpop': 'https://stream.hunter.fm/kpop/192.m3u8',
    'mpb': 'https://stream.hunter.fm/mpb/192.m3u8'}
...
def get_info(radio):
    radios = {'sertanejo': 'jld3aw2-d1a2s1d-sdwadsfawd', 'pop': 'jl2vwy6i-apswl5mr-onw1zw43kc', 'pagode': '3522-b9236sd665-94768sdh36', 'rock': 'jic321Sd-dawd1S27s-Se24s1daw2', 'gospel': '8763gs4-2312312-q421st52a', 'modasertaneja': '67sd22-fghd234-456ifgsa1hj', 'pisadinha': '21412q-634fsdda-56756dfsa', 'pop2k': 'jl339l70-23gg7tj7-hf6w8d3hg2', 'tropical': 'jld3aw2-2312312-qwfast85d', 'lofi': 'jic321Sd-de2s3d7s-S12e24s1daw2', '80s': 'ji%C3%A732234-22d21sd23-4sqq312dsas', 'hitsbrasil': 'ji%C3%A751234-22d21sd23-4121111dsas', 'kpop': 'gac501Sd-dtwd1S27s-Se24s1daq3', 'master': '1587ga5-2245587-q516sh57b', 'mpb': '55dfsss-6785lkjda-678dafgh'}
    ...
    if now:
        ...
        if singers:
            artist = ', '.join(singers)
        if hashThumb:     
            icon = 'https://cdn.hunter.fm/image/thumb/music/%s/300x300ht.jpg'%hashThumb
...
def radios_menu(params):
    item(params={'name': 'Master', 'iconimage': image_radio('master'), 'action': 'play_radio', 'radio': 'master'},folder=False)
    ...
    item(params={'name': 'K-Pop', 'iconimage': image_radio('k-pop'), 'action': 'play_radio', 'radio': 'kpop'},folder=False)
    ...
    item(params={'name': 'MPB', 'iconimage': image_radio('mpb'), 'action': 'play_radio', 'radio': 'mpb'},folder=False)
