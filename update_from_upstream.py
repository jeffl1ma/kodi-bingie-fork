...
Baixa as versoes mais recentes dos repositorios oficiais e reaplica todas as nossas correcoes e traducoes.
"""
...
UPSTREAM_REPOS = {
    "skin.bingie": "https://github.com/matke-84/skin.bingie/archive/refs/heads/main.zip",
    "plugin.video.dexhub": "https://github.com/6ahd/plugin.video.dexhub/archive/refs/heads/main.zip"
}
...
def download_and_extract(url, target_folder):
    ...
    with zipfile.ZipFile(zip_temp, 'r') as zip_ref:
        ...
        # A primeira pasta extraida e o nome do branch (ex: skin.bingie-main)
        ...
        if extracted_dirs:
            ...
            # Sincronizar arquivos para target_folder mantendo nossas modificacoes
            for root, dirs, files in os.walk(src_dir):
                rel_path = os.path.relpath(root, src_dir)
                dest_root = os.path.join(target_folder, rel_path)
                os.makedirs(dest_root, exist_ok=True)
                for f in files:
                    # Nao sobrescrever nossas traducoes nem layouts corrigidos do upnext
...
def apply_patches():
    print(" -> Reaplicando correcoes e integracoes personalizadas...")
...
def main():
    print("=" * 60)
    print("ATUALIZADOR AUTOMATICO DA SUITE BINGIE")
    print("=" * 60)

    for addon_name, url in UPSTREAM_REPOS.items():
    ...
    print("Todas as correcoes e traducoes foram preservadas nos novos ZIPs.")
    print("=" * 60)
